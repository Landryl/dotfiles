...
color01="e3/56/4d" # Base 08 - Red     - Variables, XML Tags
color16="dd/87/56" # Base 09 - Orange  - Int, Bool, Constants
color03="fe/cf/63" # Base 0A - Yellow  - Classes, Search
color02="b2/d8/89" # Base 0B - Green   - String
color06="75/75/9c" # Base 0C - Cyan    - Regular Expression, Escape Char
color04="f1/79/6b" # Base 0D - Blue    - Functions, Methods
color05="b2/94/bb" # Base 0E - Magenta - Keywords, Markup Italic
color17="5e/5e/5e" # Base 0F - Brown   - Deprecated
